...
import ZeboRobot.modules.sql.notes_sql as sql
from ZeboRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ZeboRobot.__main__ import DATA_IMPORT
...
# from ZeboRobot.modules.rules import get_rules
import ZeboRobot.modules.sql.rules_sql as rulessql

# from ZeboRobot.modules.sql import warns_sql as warnssql
import ZeboRobot.modules.sql.blacklist_sql as blacklistsql
from ZeboRobot.modules.sql import disable_sql as disabledsql

# from ZeboRobot.modules.sql import cust_filters_sql as filtersql
# import ZeboRobot.modules.sql.welcome_sql as welcsql
import ZeboRobot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("ZeboRobot{}.backup".format(chat_id), "w") as f:
