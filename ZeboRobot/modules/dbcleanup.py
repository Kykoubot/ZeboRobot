...
import ZeboRobot.modules.sql.global_bans_sql as gban_sql
import ZeboRobot.modules.sql.users_sql as user_sql
from ZeboRobot import DEV_USERS, OWNER_ID, dispatcher
