...
from ZeboRobot import DRAGONS, dispatcher
...
from ZeboRobot.modules.helper_funcs.admin_rights import user_can_changeinfo, user_can_promote
from ZeboRobot.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from ZeboRobot import SUPPORT_CHAT
            ...
            msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "➡️ Go to message", url=f"{message_link}")
                        ]
                    ]
                ), 
                parse_mode=ParseMode.HTML,
...
def pinned(update: Update, context: CallbackContext) -> str:
    ...
    if chat.pinned_message:
        ...
        msg.reply_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="➡️ Go to message", url=f"https://t.me/{link_chat_id}/{pinned_id}")]]
            ),
        )
...
def adminlist(update, context):
    ...
    text = "STAFF GRUP <b>{}</b>:".format(html.escape(update.effective_chat.title))
